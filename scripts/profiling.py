...
paths = [
    ...
    os.path.join(os.path.dirname(__file__), "..", "whitecrowparrot", "sheets/gamejam"),
    os.path.join(os.path.dirname(__file__), "..", "whitecrowparrot", "scenes/gamejam"),
    os.path.join(os.path.dirname(__file__), "..", "whitecrowparrot", "scripts"),
    os.path.join(os.path.dirname(__file__), "..", "whitecrowparrot", "players")
]
